...
const style = {
  ...
  reactionsContainer: `sm:visible invisible flex justify-between w-full px-2 gap-5`,
...
const TinderCardItem = ({ card }) => {
 const { handleRightSwipe, currentAccount } =  useStateContext();
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundImage: `url('${card.profileImage}')` }}
      >

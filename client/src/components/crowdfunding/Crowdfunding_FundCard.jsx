      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          {/* <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
           ...
           <span className= "font-semibold text-white pt-2">   <BiWallet size={25}/> </span>  
          <p className="flex-1 font-epilogue font-normal text-[12px] text-[#808191] truncate">Owner by: <span className="text-[#b2b3bd]">{owner.substring(0,5) + '..........' + owner.substring(owner.length-5,owner.length) }</span></p>
        </div>
      </div>
    </div>
  )
